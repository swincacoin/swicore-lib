...
var TESTNET = {
  PORT: 51474,//19999,
  NETWORK_MAGIC: BufferUtil.integerAsBuffer(0x457665ba),//0xcee2caff),
  DNS_SEEDS: [
    'pivx-testnet.seed.fuzzbawls.pw',//'testnet-seed.darkcoin.io',
    'pivx-testnet.seed2.fuzzbawls.pw',//'testnet-seed.dashdot.io',
    's3v3nh4cks.ddns.net'//'test.dnsseed.masternode.io'
  ]
};
...
var REGTEST = {
  PORT: 51476,
  NETWORK_MAGIC: BufferUtil.integerAsBuffer(0xa1cf7eac),//0xfcc1b7dc),
  DNS_SEEDS: []
};
